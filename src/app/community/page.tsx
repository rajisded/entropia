...
const socialChannels = [
    ...
    {
        name: "Whatsapp",
        href: "https://chat.whatsapp.com/BdMxizIZZDvKW3nZaS2nuz",
        icon: (
    ...
    {
        name: "Reddit",
        href: "https://www.reddit.com/r/entropiacity/",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
        name: "LinkedIn",
        href: "https://www.linkedin.com/company/entropiacity/",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
        name: "Instagram",
        href: "https://www.instagram.com/entropiacity",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
        name: "YouTube",
        href: "https://www.youtube.com/@entropiacity",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
const telegramRooms = [
    { name: "English", icon: "message", href: "http://t.me/entropiacity" },
];
                    ...
                    <section className="space-y-8">
                        ...
                        <div className="flex flex-wrap gap-x-8 gap-y-10 md:gap-x-12">
                            {socialChannels.map((channel, i) => (
                                <a href={channel.href} target="_blank" rel="noopener noreferrer" key={i} className="flex flex-col items-center gap-3 w-[80px] group cursor-pointer hover:scale-105 transition-transform">
                            ...
                            {telegramRooms.map((room, i) => (
                                <div key={i} className="bg-white border border-gray-200 p-5 rounded-xl hover:border-black transition-colors group cursor-pointer flex flex-col justify-between h-[120px] shadow-sm">
                                    ...
                                    <div className="flex items-center justify-between mt-4">
                                        <a href={room.href} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between w-full group">
